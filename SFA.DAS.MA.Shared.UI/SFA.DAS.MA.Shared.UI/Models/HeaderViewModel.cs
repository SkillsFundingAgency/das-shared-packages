...
namespace SFA.DAS.MA.Shared.UI.Models
{
    public class HeaderViewModel : IHeaderViewModel
    {
            ...
            bool useLegacyStyles = false)
        {
            ...
            AddOrUpdateLink(new Apprentices(_urlHelper.GetPath(userContext, configuration.EmployerCommitmentsBaseUrl, string.Empty), UseLegacyStyles ? "" : "das-navigation__link", isLegacy: UseLegacyStyles));
