...
namespace SFA.DAS.Configuration.UnitTests.ConfigurationServiceTests
{
    public class WhenGetting
    {
        ...
        public void Arrange()
        {
            ...
            _configurationRepo.Setup(repo => repo.Get("SFA.DAS.Configuration.UnitTests", "Dev", "1.0")).Returns(Task.FromResult(devConfig));
            _configurationRepo.Setup(repo => repo.Get("SFA.DAS.Configuration.UnitTests", "SIT", "1.0")).Returns(Task.FromResult(sitConfig));
        ...
        public async Task ThenItShouldReturnNullWhenConfigurationNotFound()
        {
            ...
            // Act
            var actual = await configurationService.Get<TestConfiguration>();
        ...
        {
            // Act
            var actual = await _configurationService.Get<TestConfiguration>();
