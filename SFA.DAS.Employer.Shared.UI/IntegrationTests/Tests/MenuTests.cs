...
namespace SFA.DAS.Employer.Shared.UI.IntegrationTests
{
    public class MenuTests : TestBase
    {
        ...
        public async Task AccountActions_Links()
        {
            ...
            Assert.Equal("https://at-login.apprenticeships.education.gov.uk/account/changepassword?clientId=test-id&returnurl=https%3a%2f%2faccounts.at-eas.apprenticeships.education.gov.uk%2fservice%2fpassword%2fchange", changePassLink.Attributes["href"].Value, ignoreCase: true); 
            Assert.Equal("https://at-login.apprenticeships.education.gov.uk/account/changeemail?clientId=test-id&returnurl=https%3a%2f%2faccounts.at-eas.apprenticeships.education.gov.uk%2fservice%2femail%2fchange", changeEmail.Attributes["href"].Value, ignoreCase: true); 
