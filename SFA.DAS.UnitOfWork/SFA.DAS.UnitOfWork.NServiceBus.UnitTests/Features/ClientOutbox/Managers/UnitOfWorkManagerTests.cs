...
namespace SFA.DAS.UnitOfWork.NServiceBus.UnitTests.Features.ClientOutbox.Managers
{
    [TestFixture]
    ...
    public class UnitOfWorkManagerTestsFixture
    {
        ...
        public UnitOfWorkManagerTestsFixture()
        {
            ...
            UnitOfWorkManager = new UnitOfWorkManager(
                ...
                UnitsOfWork.Select(u => u.Object).Concat(new [] { new NServiceBus.Pipeline.UnitOfWork(null, null) }),
