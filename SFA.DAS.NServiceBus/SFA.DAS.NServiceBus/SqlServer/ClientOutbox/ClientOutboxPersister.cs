...
namespace SFA.DAS.NServiceBus.SqlServer.ClientOutbox
{
    ...
    public class ClientOutboxPersister : IClientOutboxStorage
    {
        ...
        public ClientOutboxPersister(DbConnection connection, IUnitOfWorkContext unitOfWorkContext)
        {
        ...
        public async Task<IClientOutboxTransaction> BeginTransactionAsync()
        {
            ...
            var outboxTransaction = new SqlClientOutboxTransaction(transaction);
        ...
        public async Task<ClientOutboxMessage> GetAsync(Guid messageId)
        {
