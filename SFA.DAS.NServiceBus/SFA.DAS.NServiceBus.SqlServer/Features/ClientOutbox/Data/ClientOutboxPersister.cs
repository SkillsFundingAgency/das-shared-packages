...
namespace SFA.DAS.NServiceBus.SqlServer.Features.ClientOutbox.Data
{
    ...
    public class ClientOutboxPersister : IClientOutboxStorage
    {
        ...
        public const string RemoveEntriesOlderThanCommandText = "DELETE TOP(@BatchSize) FROM dbo.ClientOutboxData WHERE Dispatched = 1 AND DispatchedAt < @DispatchedBefore AND PersistenceVersion = '1.0.0'";
        public const int CleanupBatchSize = 10000;
        
        private readonly IDateTimeService _dateTimeService;
        private readonly Func<DbConnection> _connectionBuilder;

        public ClientOutboxPersister(IDateTimeService dateTimeService, IReadOnlySettings settings)
        {
        ...
        public async Task<ClientOutboxMessage> GetAsync(Guid messageId, ISynchronizedStorageSession synchronizedStorageSession)
        {
